本文题解基于以下原题整理，题意经本人重新表述，解题思路与代码均为原创或转载，仅用于个人学习与交流，完整题目请务必查阅官方原题链接：[1390. 四因数 - 力扣（LeetCode）](https://leetcode.cn/problems/four-divisors/description/?envType=daily-question&envId=2026-01-04)
...
给定一个整数数组 `nums`，对于数组中的每个整数，如果它恰好有四个正因数，则计算它的所有因数之和。最后返回所有满足条件的整数的因数之和的总和；如果没有整数恰好有四个因数，则返回 `0`。

## **示例说明**

- **示例1**：`nums = [21,4,7]`，21 有四个因数（1,3,7,21），和为 32；4 有三个因数；7 有两个因数。因此结果为 32。
- **示例2**：`nums = [21,21]`，两个 21 各有四个因数，每个的和为 32，总和为 64。
- **示例3**：`nums = [1,2,3,4,5]`，这些数都没有恰好四个因数，因此返回 0。
...
![1390_四因数_Java_解法1](https://gitee.com/lei-weijun/CodingLearning/raw/main/DailyAlgorithm/LeetCode/9_%E6%95%B0%E5%AD%A6%E7%AE%97%E6%B3%95/Images/1390_%E5%9B%9B%E5%9B%A0%E6%95%B0_Java_%E8%A7%A3%E6%B3%951.png)
...
![1390_四因数_Java_解法2](https://gitee.com/lei-weijun/CodingLearning/raw/main/DailyAlgorithm/LeetCode/9_%E6%95%B0%E5%AD%A6%E7%AE%97%E6%B3%95/Images/1390_%E5%9B%9B%E5%9B%A0%E6%95%B0_Java_%E8%A7%A3%E6%B3%952.png)
